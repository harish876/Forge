...
class Assembler():
    ...
    def yield_job_chain(self, job_name: str):
        ...
        for step in job_steps:
            ...
            if step_type == "extractor" or step_type == "extract":
